...
export class StorageService {
    ...
    async updateUserDetailsById(id: string, name: string, cidade: string, email: string) {
        const sql = `UPDATE users SET name=?, cidade=?, email=? WHERE id=?`;
        await this.db.run(sql, [name, cidade, email, id]);
        await this.getUsers();
    }
